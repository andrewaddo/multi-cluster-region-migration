...
echo "2. Deploy to Singapore: kubectl --context=gke_${PROJECT_ID}_${REGION_SG}_${CLUSTER_SG} apply -f k8s/deployment.yaml"
echo "3. Run performance test: python scripts/performance_test.py http://<SG_IP>/status"
echo "--------------------------------------------------"
